...
class LoginForm extends Component{
    ...
    render(){
        const {userName,password,email,showUsernameError,showEmailError,showPasswordError,showFieldsError} = this.state;
            ...
            <div className="bg-container">
                ...
                <form className="form-container" onSubmit={this.formClicked}>
                    ...
                    <input
                     ...
                     /><br/>
                     {showUsernameError?(<p className="error-msg">* fields are mandatory</p>):''}
                    ...
                    <input
                     ...
                     /><br/>
                     {showEmailError?(<p className="error-msg">* fields are mandatory</p>):''}
                    ...
                    <input
                     ...
                     /><br/>
                     {showPasswordError || showFieldsError ?(<p className="error-msg">* fields are mandatory</p>):''}
                    <button type="submit">SignUp</button>
                    <p className="have-text">Already have an account ?<span className="sign-in">SignIn</span></p>
                </form>
            </div>
        )
    }
